...
def _ozon_extract_product_id(url: str) -> str:
    splitedStr = url.split("/")[-2]
    ID = splitedStr[-10:]
    return ID

def _wb_extract_product_id(url: str) -> str:
    splitedStr = url.split("/")[-2]
    return splitedStr

print(_ozon_extract_product_id("https://www.ozon.ru/product/nabor-kvadratnyh-konteynerov-dlya-edy-i-hraneniya-fusion-6-sht-2082762097/?campaignId=543"))
print(_wb_extract_product_id("https://www.wildberries.ru/catalog/262136152/detail.aspx"))
