        ...
        try:
            ...
            if actual_price_with_card != previous_price_with_card:
                ...
                try:
                    ...
                    raise PriceUpdateError(f'Ошибка обновления цены товара {product_id}')
            ...
            logger.info(f'Данные, возвращаемые UpdateProductPriceUseCase: {data_return}')
            ...
            logger.exception(f'Неизвестная ошибка при обновлении цены товара {product_id}: {str(e)}')
