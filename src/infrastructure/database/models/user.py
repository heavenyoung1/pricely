...
class ORMUser(Base):
    ...
    id: Mapped[str] = mapped_column(String, primary_key=True)  # Уникальный идентификатор пользователя
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, default=datetime.now)  # Дата создания
