...
class ORMProduct(Base):
    ...
    price: Mapped['ORMPrice'] = relationship('ORMPrice', foreign_keys=[price_id], uselist=False)
    prices: Mapped[list['ORMPrice']] = relationship('ORMPrice', foreign_keys='ORMPrice.product_id')
