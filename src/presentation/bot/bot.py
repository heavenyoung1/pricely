...
def register_callback_handlers(dp):
    ...
    dp.callback_query.register(
        handle_delete_product_request,
        lambda call: call.data.startswith("delete_product:"),
    )
    dp.callback_query.register(
        handle_confirm_delete, lambda call: call.data.startswith("confirm_delete:")
    )
    dp.callback_query.register(
        handle_cancel_delete, lambda call: call.data.startswith("cancel_delete:")
    )
    ...
    # Действия с товарами
    dp.callback_query.register(
        handle_product_button, lambda call: call.data.startswith("product:")
    )
