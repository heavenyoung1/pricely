...
@pytest.mark.unit
def test_create_user_use_case_success(pure_mock_user_repo, user):
    use_case = CreateUserUseCase(user_repo=pure_mock_user_repo)
...
@pytest.mark.unit
def test_create_user_use_case_user_exists(pure_mock_user_repo, user):
