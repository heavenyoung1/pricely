...
# @pytest.mark.integration
# def test_get_full_product_success(uow, product, price_created_first , user, pure_mock_parser):
#     service = ProductService(uow_factory=lambda: uow, parser=pure_mock_parser)
...
# @pytest.mark.integration
# def test_create_product_success(uow, product , user, pure_mock_parser):
#     service = ProductService(uow_factory=lambda: uow, parser=pure_mock_parser)
...
#     with uow:
#         product_getted = uow.product_repository.get(product_id=product.id)
#         assert product_getted is not None
